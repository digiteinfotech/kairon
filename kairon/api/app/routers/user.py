...
async def allow_bot_for_user(
        ...
        bot: str = Path(description="bot id", example="613f63e87a1d435607c3c183"),
...
async def accept_bot_collaboration_invite_with_token_validation(
        ...
        token: RecaptchaVerifiedTextData, bot: str = Path(description="bot id", example="613f63e87a1d435607c3c183")
):
    """
...
async def remove_member_from_bot(
        user: str = Path(description="user mail id", example="user@kairon.ai"),
        bot: str = Path(description="bot id", example="613f63e87a1d435607c3c183"),
        current_user: User = Security(Authentication.get_current_user_and_bot, scopes=ADMIN_ACCESS)
):
    """
