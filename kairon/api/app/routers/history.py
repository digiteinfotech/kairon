...
async def new_users_trend(month: int = Query(default=6, ge=2, le=6), current_user: User = Depends(auth.get_current_user_and_bot)):
    """
...
async def complete_conversation_trend(month: int = Query(default=6, ge=2, le=6), current_user: User = Depends(auth.get_current_user_and_bot)):
    """
...
async def retention_trend(month: int = Query(default=6, ge=2, le=6), current_user: User = Depends(auth.get_current_user_and_bot)):
    """
...
async def fallback_trend(month: int = Query(default=6, ge=2, le=6), current_user: User = Depends(auth.get_current_user_and_bot)):
    """
...
async def flat_conversations(month: int = Query(default=1, ge=1, le=6), current_user: User = Depends(auth.get_current_user_and_bot)):
    """
