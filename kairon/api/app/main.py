...
from kairon.api.app.routers.bot import action, bot, agents, secrets, multilingual, metering
...
app.include_router(metering.router, prefix="/api/bot/{bot}/metering", tags=["Metering"])
