...
from kairon.api.app.routers.bot import action, bot, agents, secrets, multilingual, metric, data_generation
...
app.include_router(data_generation.router, prefix="/api/bot/{bot}/data/generator", tags=["DataGenerator"])
