...
from kairon.crm.routes import router as crm_router
...
app.include_router(crm_router, prefix="/api/bot/{bot}/crm", tags=["CRM"])
...
app.include_router(bot_speech_provider_config.router, prefix="/api/bot/{bot}/speech/provider-config", tags=["SpeechProviderConfig"])
app.include_router(customer_orders.router, prefix="/api/bot/{bot}/customer_data", tags=["CustomerData"])
