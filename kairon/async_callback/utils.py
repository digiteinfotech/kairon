...
class CallbackUtility:
    ...
    def execute_script(source_code: Text, predefined_objects: Dict = None):
        ...
        predefined_objects['save_data'] = partial(CallbackScriptUtility.save_data, bot=bot)
        predefined_objects['fetch_data'] = partial(CallbackScriptUtility.fetch_data, bot=bot)
