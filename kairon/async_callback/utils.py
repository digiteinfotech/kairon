...
class CallbackUtility:
    ...
    def execute_script(source_code: Text, predefined_objects: Dict = None):
        ...
        predefined_objects['add_analyitcs_raw_data'] = partial(CallbackScriptUtility.add_data_analytics, bot=bot)
        predefined_objects['get_analyitcs_raw_data'] = partial(CallbackScriptUtility.get_data_analytics, bot=bot)
        predefined_objects['processed_analyitcs_raw_data'] = partial(CallbackScriptUtility.mark_as_processed, bot=bot)
