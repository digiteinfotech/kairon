...
class DataImporterLogProcessor:
    ...
    @staticmethod
    def add_log(bot: str, user: str, summary: dict = None, is_data_uploaded: bool = True, exception: str = None,
                validation_status: str = None, event_status: str = EVENT_STATUS.INITIATED.value):
        """
        ...
        @param validation_status: Validation success or failure.
