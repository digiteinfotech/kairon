...
class AccountProcessor:
    ...
    async def overwrite_password(token: str, password: str):
        ...
        user_act_log = AuditLogData.objects(audit__Bot_id='None', user=email, action=AuditlogActions.ACTIVITY.value, entity=UserActivityType.reset_password.value)
        ...
        if uuid_value is not None:
            AuditLogData.objects(audit__Bot_id='None', user=email, action=AuditlogActions.ACTIVITY.value,
                                 entity=UserActivityType.link_usage.value,
