...
from rasa.shared.core.domain import InvalidDomain, warn_about_duplicates_found_during_domain_merging, _validate_forms, EntityProperties, SessionConfig, SubState, State, ActionNotFoundException
...
DOMAIN_SCHEMA_FILE = "shared/schemas/domain.yml"
PACKAGE_NAME = "kairon"
...
class Domain:
    ...
    def from_yaml(cls, yaml: Text, original_filename: Text = "") -> "Domain":
        ...
        try:
            rasa.shared.utils.validation.validate_yaml_schema(yaml, DOMAIN_SCHEMA_FILE, PACKAGE_NAME)
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.action_names_or_texts = (
            ...
            +[
                loop
                for loop in self.loop_names
                if loop not in self._custom_actions
            ]
        )
