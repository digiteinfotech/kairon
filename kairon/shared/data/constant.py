...
ALLOWED_NLU_FORMATS = {"nlu.yml", "nlu.yml", "nlu.yaml"}
ALLOWED_STORIES_FORMATS = {"stories.yml", "stories.yml", "stories.yaml"}
...
ALLOWED_CHAT_CLIENT_CONFIG_FORMATS = {
    "chat_client_config.yml",
    "chat_client_config.yaml",
}
REQUIREMENTS = {
    "nlu",
    "domain",
...
COMPONENT_COUNT = {
    ...
    "http_actions": 0,
    "jira_actions": 0,
    "google_search_actions": 0,
    "zendesk_actions": 0,
    "email_actions": 0,
    "slot_set_actions": 0,
    "form_validation_actions": 0,
    "rules": 0,
    "domain": {
        "intents": 0,
        "actions": 0,
