...
class AgentProcessor:
    ...
    def reload(bot: Text, email: str = None):
        ...
        try:
            ...
            UserActivityLogger.add_log(a_type=UserActivityType.reload_model_completion.value,
                                       bot=bot, message=['Model reload completed!'],
                                       data={"username": email, "process_id": os.getpid()})
        except Exception as e:
            UserActivityLogger.add_log(a_type=UserActivityType.reload_model_failure.value,
