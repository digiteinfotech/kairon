...
async def engaged_users(request: HistoryQuery = HistoryQuery(),
...
async def new_users(request: HistoryQuery = HistoryQuery(),
                    collection: str = Depends(Authentication.authenticate_and_get_collection)):
...
async def complete_conversation(request: HistoryQuery = HistoryQuery(),
                                collection: str = Depends(Authentication.authenticate_and_get_collection)):
...
async def user_retention(request: HistoryQuery = HistoryQuery(),
                         collection: str = Depends(Authentication.authenticate_and_get_collection)):
...
async def fallback(request: HistoryQuery = HistoryQuery(),
                   collection: str = Depends(Authentication.authenticate_and_get_collection)):
...
async def total_conversations(request: HistoryQuery = HistoryQuery(),
                              collection: str = Depends(Authentication.authenticate_and_get_collection)):
