...
class TestLLM:
    ...
    def test_gpt3_faq_embedding_train(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_faq_embd/points"),
                method="PUT",
                adding_headers={},
    ...
    def test_gpt3_faq_embedding_train_payload_text(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                ...
                match=[responses.matchers.json_params_matcher({'points': [{'id': test_content.vector_id,
                                                                           'vector': embedding,
                                                                           'payload': {'collection_name': 'test_embed_faq_text_User_Details_faq_embd',
                                                                                       'name': 'Nupur'}
                                                                           }]})],
                json={"result": {"operation_id": 0, "status": "acknowledged"}, "status": "ok", "time": 0.003612634}
            )
    ...
    def test_gpt3_faq_embedding_train_payload_with_int(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                "DELETE",
                urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_json_faq_embd"),
                adding_headers={}
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_json_faq_embd"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher(
                    {'name': 'test_embed_faq_json_faq_embd', 'vectors': gpt3.vector_config})],
                status=200
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_json_faq_embd/points"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher({'points': [{'id': test_content.vector_id,
                                                                           'vector': embedding,
    ...
    def test_gpt3_faq_embedding_train_int(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                "DELETE",
                urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_int_faq_embd"),
                adding_headers={}
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_int_faq_embd"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher(
                    {'name': 'test_embed_faq_int_faq_embd', 'vectors': gpt3.vector_config})],
                status=200
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_int_faq_embd/points"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher({'points': [{'id': test_content.vector_id,
                                                                           'vector': embedding,
    ...
    def test_gpt3_faq_embedding_train_payload_json_no_metadata(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                "DELETE",
                urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_json_no_metadata_faq_embd"),
                adding_headers={}
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_json_no_metadata_faq_embd"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher(
                    {'name': 'test_embed_faq_json_no_metadata_faq_embd', 'vectors': gpt3.vector_config})],
                status=200
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_json_no_metadata_faq_embd/points"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher({'points': [{'id': test_content.vector_id,
                                                                           'vector': embedding,
                                                                           'payload': {'age': 25, 'city': 'Bengaluru', 'collection_name': 'test_embed_faq_json_no_metadata_faq_embd', 'name': 'Nupur'}
                                                                           }]})],
                json={"result": {"operation_id": 0, "status": "acknowledged"}, "status": "ok", "time": 0.003612634}
            )
    ...
    def test_gpt3_faq_embedding_train_upsert_error(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                "DELETE",
                urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_not_exists_faq_embd"),
                adding_headers={}
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_not_exists_faq_embd"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher({'name': 'test_embed_faq_not_exists_faq_embd', 'vectors': gpt3.vector_config})],
                status=200
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_not_exists_faq_embd/points"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher({'points': [{'id': test_content.vector_id,
                                                                  'vector': embedding,
    ...
    def test_gpt3_faq_embedding_train_payload_upsert_error_json(self):
        ...
        with mock.patch.dict(Utility.environment, {'llm': {"faq": "GPT3_FAQ_EMBED", 'api_key': secret}}):
            ...
            responses.add(
                "DELETE",
                urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_payload_upsert_error_faq_embd"),
                adding_headers={}
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_payload_upsert_error_faq_embd"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher(
                    {'name': 'test_embed_faq_payload_upsert_error_faq_embd', 'vectors': gpt3.vector_config})],
                status=200
            )

            responses.add(
                url=urljoin(Utility.environment['vector']['db'], f"/collections/test_embed_faq_payload_upsert_error_faq_embd/points"),
                method="PUT",
                adding_headers={},
                match=[responses.matchers.json_params_matcher({'points': [{'id': test_content.vector_id,
                                                                           'vector': embedding,
                                                                           'payload': {'collection_name': 'test_embed_faq_payload_upsert_error_faq_embd',
                                                                                       "filter": {
                                                                                           "should": [
                                                                                               {"key": "city",
                                                                                                "match": {
