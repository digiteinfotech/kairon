    ...
    def test_add_multiflow_story_with_stop_flow_action(self):
        ...
        steps = [
            ...
            {"step": {"name": "utter_goodbye", "type": "BOT", "node_id": "5",
                      "component_id": "63gm5BzYuhC1bc6yzysEnN4E"},
             "connections": [
                 {"name": "stop_flow", "type": "STOP_FLOW_ACTION", "node_id": "7", "component_id": "63gm5BzYuhC1bc6yzysEnN65"}]
             },
            {"step": {"name": "stop_flow", "type": "STOP_FLOW_ACTION", "node_id": "7", "component_id": "63gm5BzYuhC1bc6yzysEnN65"},
             "connections": None
             },
        ]
        story_dict = {'name': "multiflow story with stop flow action", 'steps': steps, 'type': 'MULTIFLOW', 'template_type': 'CUSTOM'}
