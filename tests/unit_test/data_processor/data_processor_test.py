...
class TestMongoProcessor:
    ...
    async def test_upload_case_insensitivity(self):
        ...
        assert domain.entities == ['user', 'location', 'email_id', 'application_name', 'bot', 'kairon_action_response',
                                   'order', 'http_status_code', 'image', 'audio', 'video', 'document', 'doc_url', 'longitude', 'latitude', 'flow_reply']
    ...
    def test_load_domain(self):
        ...
        assert isinstance(domain, Domain)
        assert domain.slots.__len__() == 13
        ...
        assert domain.entities.__len__() == 12
    ...
    def test_get_entities(self):
        ...
        expected = ["bot", "priority", "file_text", "ticketid", 'kairon_action_response', 'image', 'video', 'audio',
                    'doc_url', 'document', 'order', 'longitude', 'latitude', 'flow_reply', 'http_status_code']
