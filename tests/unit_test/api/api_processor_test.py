...
class TestAccountProcessor:
    ...
    async def test_sso_login_google_not_enabled(self):
        ...
        with pytest.raises(AppException, match='Failed to verify with google: google login is not enabled'):
    ...
    async def test_sso_login_facebook_not_enabled(self):
        ...
        request = Request({'type': 'http',
                           'headers': Headers({}).raw,
                           'query_string': 'code=AQDKEbWXmRjtjiPdGUxXSTuye8ggMZvN9A_cXf1Bw9j_FLSe_Tuwsf_EP-LmmHVAQqTIhqL1Yj7mnsnBbsQdSPLC_4QmJ1GJqM--mbDR0l7UAKVxWdtqy8YAK60Ws02EhjydiIKJ7duyccCa7vXZN01XPAanHak2vvp1URPMvmIMgjEcMyI-IJR0k9PR5NHCEKUmdqeeFBkyFbTtjizGvjYee7kFt7T6_-6DT3q9_1fPvC9VRVPa7ppkJOD0n6NW4smjtpLrEckjO5UF3ekOCNfISYrRdIU8LSMv0RU3i0ALgK2CDyp7rSzOwrkpw6780Ix-QtgFOF4T7scDYR7ZqG6HY5vljBt_lUE-ZWjv-zT_QHhv08Dm-9AoeC_yGNx1Wb8&state=f7ad9a88-be24-4d88-a3bd-3f02b4b12a18&scope=email profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile openid&authuser=0&hd=digite.com&prompt=none'})
        with pytest.raises(AppException, match='Failed to verify with facebook: facebook login is not enabled'):
    ...
    async def test_sso_login_linkedin_not_enabled(self):
        ...
        request = Request({'type': 'http',
                           'headers': Headers({}).raw,
                           'query_string': 'code=AQDKEbWXmRjtjiPdGUxXSTuye8ggMZvN9A_cXf1Bw9j_FLSe_Tuwsf_EP-LmmHVAQqTIhqL1Yj7mnsnBbsQdSPLC_4QmJ1GJqM--mbDR0l7UAKVxWdtqy8YAK60Ws02EhjydiIKJ7duyccCa7vXZN01XPAanHak2vvp1URPMvmIMgjEcMyI-IJR0k9PR5NHCEKUmdqeeFBkyFbTtjizGvjYee7kFt7T6_-6DT3q9_1fPvC9VRVPa7ppkJOD0n6NW4smjtpLrEckjO5UF3ekOCNfISYrRdIU8LSMv0RU3i0ALgK2CDyp7rSzOwrkpw6780Ix-QtgFOF4T7scDYR7ZqG6HY5vljBt_lUE-ZWjv-zT_QHhv08Dm-9AoeC_yGNx1Wb8&state=f7ad9a88-be24-4d88-a3bd-3f02b4b12a18&scope=email profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile openid&authuser=0&hd=digite.com&prompt=none'})
        with pytest.raises(AppException, match='Failed to verify with linkedin: linkedin login is not enabled'):
    ...
    async def test_verify_and_process_google(self, monkeypatch):
        ...
        request = Request({'type': 'http',
                           'headers': Headers({}).raw,
                           'query_string': 'code=AQDKEbWXmRjtjiPdGUxXSTuye8ggMZvN9A_cXf1Bw9j_FLSe_Tuwsf_EP-LmmHVAQqTIhqL1Yj7mnsnBbsQdSPLC_4QmJ1GJqM--mbDR0l7UAKVxWdtqy8YAK60Ws02EhjydiIKJ7duyccCa7vXZN01XPAanHak2vvp1URPMvmIMgjEcMyI-IJR0k9PR5NHCEKUmdqeeFBkyFbTtjizGvjYee7kFt7T6_-6DT3q9_1fPvC9VRVPa7ppkJOD0n6NW4smjtpLrEckjO5UF3ekOCNfISYrRdIU8LSMv0RU3i0ALgK2CDyp7rSzOwrkpw6780Ix-QtgFOF4T7scDYR7ZqG6HY5vljBt_lUE-ZWjv-zT_QHhv08Dm-9AoeC_yGNx1Wb8&state=f7ad9a88-be24-4d88-a3bd-3f02b4b12a18&scope=email profile https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile openid&authuser=0&hd=digite.com&prompt=none'})
        existing_user, user, token = await LoginSSOFactory.verify_and_process(request, "google")
    ...
    async def test_verify_and_process_facebook(self, monkeypatch):
        ...
        existing_user, user, token = await LoginSSOFactory.verify_and_process(request, "facebook")
        assert Utility.decode_limited_access_token(token)["sub"] == "monisha.ks@digite.com"
        assert user['email'] == 'monisha.ks@digite.com'
    ...
    async def test_sso_linkedin_login_success(self, httpx_mock: HTTPXMock, monkeypatch):
        ...
        request = Request(scope=scope)
        request._url = URL(scope=scope)
        existing_user, user, token = await LoginSSOFactory.verify_and_process(request, "linkedin")
        assert Utility.decode_limited_access_token(token)["sub"] == "monisha.ks@digite.com"
        assert user['email'] == 'monisha.ks@digite.com'
        assert user['first_name'] == 'monisha'
    ...
    def test_sso_login_client_linkedin(self):
        assert LoginSSOFactory.linkedin_sso.client_secret == Utility.environment['sso']['linkedin']['client_secret']
        assert LoginSSOFactory.linkedin_sso.client_id == Utility.environment['sso']['linkedin']['client_id']
        assert LoginSSOFactory.linkedin_sso.redirect_uri == urljoin(Utility.environment['sso']['redirect_url'], 'linkedin')

    def test_sso_login_client_gmail(self):
        assert LoginSSOFactory.google_sso.client_secret == Utility.environment['sso']['google']['client_secret']
        assert LoginSSOFactory.google_sso.client_id == Utility.environment['sso']['google']['client_id']
        assert LoginSSOFactory.google_sso.redirect_uri == urljoin(Utility.environment['sso']['redirect_url'], 'google')

    def test_sso_login_client_facebook(self):
        assert LoginSSOFactory.facebook_sso.client_secret == Utility.environment['sso']['facebook']['client_secret']
        assert LoginSSOFactory.facebook_sso.client_id == Utility.environment['sso']['facebook']['client_id']
        assert LoginSSOFactory.facebook_sso.redirect_uri == urljoin(Utility.environment['sso']['redirect_url'], 'facebook')
