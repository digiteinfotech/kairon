...
class WebsiteTrainingDataGeneratorUtil:
    ...
    def set_training_data_status(kairon_url: str, status: Dict, user: str, token: str):
        return WebsiteTrainingDataGeneratorUtil.http_request('PUT',
    ...
    def fetch_latest_data_generator_status(kairon_url: str, user: str, token: str):
        response = WebsiteTrainingDataGeneratorUtil.http_request('GET',
