...
class TestUtility:
    ...
    async def test_write_training_data(self):
        ...
        training_data_path = Utility.write_training_data(training_data, domain, config, story_graph, None)
    ...
    def test_write_training_data_with_rules(self):
        ...
        training_data_path = Utility.write_training_data(training_data, domain, config, story_graph, rules)
        assert os.path.exists(training_data_path)
