...
class TestWhatsappCloud:
    ...
    @pytest.mark.asyncio
    async def test_whatsapp_cloud_send_template_message(self, whatsapp_cloud):
        name = "test_template_name"
        to_phone_number = "9876543210"
        components = {
            "type": "body",
    ...
    @pytest.mark.asyncio
    async def test_whatsapp_cloud_send_template_message_without_payload(self, whatsapp_cloud):
        name = "test_template_name"
        to_phone_number = "9876543210"
        with patch("kairon.chat.handlers.channels.clients.whatsapp.cloud.WhatsappCloud.send",
                   autospec=True) as mock_send:
    ...
    @pytest.mark.asyncio
    async def test_whatsapp_cloud_send_template_message_with_namespace(self, whatsapp_cloud):
        namespace = "test_namespace"
        name = "test_template_name"
        to_phone_number = "9876543210"
        with patch("kairon.chat.handlers.channels.clients.whatsapp.cloud.WhatsappCloud.send",
    ...
    @pytest.mark.asyncio
    async def test_whatsapp_cloud_send_template_message_failure(self, whatsapp_cloud):
        name = "test_template_name"
        to_phone_number = "invalid_ph_no"
        with patch("kairon.chat.handlers.channels.clients.whatsapp.cloud.WhatsappCloud.send",
                   autospec=True) as mock_send:
