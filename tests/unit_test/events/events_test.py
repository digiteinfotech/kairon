...
class TestEventExecution:
    ...
    def test_trigger_data_importer_multiflow(self, monkeypatch, get_training_data):
        bot = 'test_trigger_data_importer_multiflow'
        user = 'test'
        test_data_path = os.path.join(pytest.tmp_dir, str(uuid.uuid4()))
        ...
        nlu, story_graph, domain, config, http_actions, multiflow_stories = asyncio.run(get_training_data('tests/testing_data/validator/valid_with_multiflow'))
