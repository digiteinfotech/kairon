...
def test_model_training():
    ...
    request = {'requestContext': {'elb': {'targetGroupArn': 'arn:aws:elasticloadbalancing:us-east-1:730423251530:targetgroup/lambda-TX4lMDoYUZbApfgNrIbQ/4a615ec885b3df97'}}, 'httpMethod': 'POST', 'path': '/validate/import', 'queryStringParameters': {}, 'headers': {'accept': '*/*', 'accept-encoding': 'gzip, deflate', 'accept-language': 'en-US,en;q=0.5', 'connection': 'keep-alive', 'content-length': '60', 'content-type': 'application/json', 'host': 'kairon-2115467540.us-east-1.elb.amazonaws.com', 'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:81.0) Gecko/20100101 Firefox/81.0', 'x-amzn-trace-id': 'Root=1-5f740d25-7880bfe721e19cf91613f209', 'x-forwarded-for': '103.203.145.3', 'x-forwarded-port': '80', 'x-forwarded-proto': 'http'}, 'body': '{  "BOT": "5f64a80453cb9f7074054c62",  "USER": "fshaikh", "IMPORT_DATA": "--import-data", "OVERWRITE":"--overwrite"}', 'isBase64Encoded': False}
