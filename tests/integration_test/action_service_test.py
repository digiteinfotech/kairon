...
from kairon.shared.actions.data_objects import HttpActionConfig, SlotSetAction, Actions, FormValidationAction, \
    ...
    DatabaseAction, DbQuery, PyscriptActionConfig, WebSearchAction, UserQuestion, FlowActionConfig
...
def test_flow_action_execution(aioresponses):
    ...
    assert log == {'type': 'flow_action', 'intent': 'flow_action', 'action': 'test_flow_action_execution',
                   ...
                   'url': 'https://waba-v2.360dialog.io/messages',
                   'request_params': {'recipient_type': 'individual', 'messaging_product': 'whatsapp', 'type': 'interactive', 'interactive': {'type': 'flow', 'action': {'name': 'flow', 'parameters': {'mode': 'published', 'flow_message_version': '3', 'flow_token': 'AQAAAAACS5FpgQ_cAAAAAD0QI3s.', 'flow_action': 'navigate', 'flow_cta': 'Sign Up', 'flow_id': '9191123456789', 'flow_action_payload': {'screen': 'REGISTER'}}}, 'body': {'text': 'Fill the Sign Up Form'}}, 'to': '919876543210'},
...
def test_flow_action_execution_with_flow_id_from_slot(aioresponses):
    ...
    assert log == {'type': 'flow_action', 'intent': 'flow_action',
                   ...
                   'sender': 'default', 'headers': {'D360-API-KEY': 'abxyYxCNkabcdefgh9OpMfIAK'},
                   'url': 'https://waba-v2.360dialog.io/messages',
                   'request_params': {'recipient_type': 'individual', 'messaging_product': 'whatsapp', 'type': 'interactive', 'interactive': {'type': 'flow', 'action': {'name': 'flow', 'parameters': {'mode': 'published', 'flow_message_version': '3', 'flow_token': 'AQAAAAACS5FpgQ_cAAAAAD0QI3s.', 'flow_action': 'navigate', 'flow_cta': 'Sign Up', 'flow_id': '919112345678900303', 'flow_action_payload': {'screen': 'REGISTER'}}}, 'body': {'text': 'Fill the Sign Up Form'}}, 'to': '919876543210'},
                   'api_response': "{'messaging_product': 'whatsapp', 'contacts': [{'input': '919876543210', 'wa_id': '919876543210'}], 'messages': [{'id': 'wamid.HBgMOTE5NTEsTdlFsldsGldlsHfsfndMEIxQTMwMjQ1MzRDQTdEAA=='}]}",
                   'bot_response': 'Flow Triggered', 'bot': '5f50fd0a56b698ca10d35d2z', 'status': 'SUCCESS',
                   'user_msg': 'get intents'}
...
def test_flow_action_execution_with_dispatch_response_disabled(aioresponses):
    ...
    assert log == {'type': 'flow_action', 'intent': 'flow_action',
                   ...
                   'sender': 'default', 'headers': {'D360-API-KEY': 'abxyYxCNkabcdefgh9OpMfIAK'},
                   'url': 'https://waba-v2.360dialog.io/messages',
                   'request_params': {'recipient_type': 'individual', 'messaging_product': 'whatsapp', 'type': 'interactive', 'interactive': {'type': 'flow', 'action': {'name': 'flow', 'parameters': {'mode': 'draft', 'flow_message_version': '3', 'flow_token': 'AQAAAAACS5FpgQ_cAAAAAD0QI3s.', 'flow_action': 'navigate', 'flow_cta': 'Sign Up', 'flow_id': '9191123498765432', 'flow_action_payload': {'screen': 'REGISTER'}}}, 'header': {'type': 'text', 'text': 'This is flow header'}, 'body': {'text': 'Fill the Sign Up Form'}, 'footer': {'text': 'This is flow footer'}}, 'to': '919876543210'},
                   'api_response': "{'messaging_product': 'whatsapp', 'contacts': [{'input': '919876543210', 'wa_id': '919876543210'}], 'messages': [{'id': 'wamid.HBgMOTE5NTEsTdlFsldsGldlsHfsfndMEIxQTMwMjQ1MzRDQTdEAA=='}]}",
                   'bot_response': 'Flow Triggered', 'bot': '5f50fd0a56b698ca10d35d2z', 'status': 'SUCCESS',
                   'user_msg': 'get intents'}
