...
def test_get_form_with_validations():
    ...
    assert form['slot_mapping'][1]['validations'] == {
        'and': [{'operator': 'is_greater_than', 'value': 10}, {'operator': 'is_less_than', 'value': 70},
                {'operator': 'starts_with', 'value': 'valid'}, {'operator': 'ends_with', 'value': 'value'}]}
    assert not form['slot_mapping'][2]['validations']
    assert form['slot_mapping'][3]['validations'] == {'and': [{'and': [
        {'operator': 'is_in', 'value': ['teacher', 'programmer', 'student', 'manager']},
        {'operator': 'has_no_whitespace', 'value': None}, {'operator': 'ends_with', 'value': 'value'}]}, {'or': [
...
def test_edit_form_add_validations():
    ...
    num_people_validation = {'logical_operator': 'and',
                             'expressions': [{'validations': [{'operator': 'is_greater_than', 'value': 1},
                                                              {'operator': 'is_less_than', 'value': 10}]}]}
    path = [{'responses': ['please give us your name?'], 'slot': 'name',
             'mapping': [{'type': 'from_text', 'value': 'user', 'entity': 'name'},
                         {'type': 'from_entity', 'entity': 'name'}],
             'validation': name_validation},
...
def test_get_form_after_edit():
    ...
    assert form['slot_mapping'][1]['validations'] == {
        'and': [{'operator': 'is_greater_than', 'value': 1}, {'operator': 'is_less_than', 'value': 10}]}
    assert not form['slot_mapping'][2]['validations']
